...
<head>
  ...
  <link rel="stylesheet" href="{{ mix('themes/erasmart/css/bootstrap.css') }}">
  <script src="{{ mix('themes/erasmart/js/app.js') }}"></script>
  <script src="{{ asset('vendor/jquery/jquery-3.7.1.min.js') }}"></script>
  <script src="{{ asset('vendor/layer/3.5.1/layer.js') }}"></script>
  <script src="{{ asset('vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <link rel="stylesheet" href="{{ mix('themes/erasmart/css/app.css') }}">
  <script>
    let urls = {
