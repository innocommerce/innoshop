...
@section('content')
  ...
  <div class="card h-min-600">
    <div class="card-body px-0 px-md-2">
      @include('plugin::plugin_market._menu_top')

      <div class="row mx-auto">
        @include('plugin::plugin_market._menu_sidebar')
    ...
    <script>
        $(function () {
            $('#btnDownload').click(function (){
                axios({
                    method: "get",
                    url: '{{ panel_route('marketplaces.download', ['id' => $product['product_id'],'type'=>'plugin']) }}',
