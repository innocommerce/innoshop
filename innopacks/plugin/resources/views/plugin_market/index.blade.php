      ...
      <div class="mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
          ...
          <div class="flex-shrink-0">
            <form method="GET" action="{{ panel_route('plugin-market.index') }}" class="d-flex" id="searchForm">
...
@push('footer')
  <style>
    ...
    :root {
      ...
      --plugin-shadow: rgba(91, 165, 255, 0.3);
      --border-color: #e9ecef;
      --bg-light: #f8f9fa;
      --text-muted: #6c757d;
    }
    ...
    /* Plugin Market Specific Product Card Styles */
    .product-item-card-plugin .product-gradient-bar {
      height: 3px;
      background: linear-gradient(90deg, var(--plugin-gradient-start) 0%, var(--plugin-gradient-end) 100%);
      z-index: 1;
    }
    .product-item-card-plugin:hover {
      box-shadow: 0 0.5rem 1rem var(--plugin-shadow) !important;
      border-color: var(--plugin-primary) !important;
    }
    .product-item-card-plugin .product-price {
      color: var(--plugin-primary);
      font-size: 1.1rem;
    }
    .product-item-card-plugin .product-view-badge {
      background-color: var(--plugin-primary);
      color: #ffffff;
      font-size: 0.85rem;
    }
    ...
    .product-item-card:hover .product-logo {
