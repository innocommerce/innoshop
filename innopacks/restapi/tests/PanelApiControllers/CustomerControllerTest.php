...
/**
 * Unit tests for Panel CustomerController.
...
class CustomerControllerTest extends TestCase
{
    ...
    public function test_update_method_has_correct_parameters(): void
    {
        ...
        $this->assertEquals('request', $parameters[0]->getName());
        $this->assertEquals('customer', $parameters[1]->getName());
    }

    #[Test]
    public function test_destroy_method_has_customer_parameter(): void
    {
        $reflection = new ReflectionClass($this->controller);
        $method     = $reflection->getMethod('destroy');
        $parameters = $method->getParameters();
        ...
        $this->assertCount(1, $parameters);
        $this->assertEquals('customer', $parameters[0]->getName());
    }
}
