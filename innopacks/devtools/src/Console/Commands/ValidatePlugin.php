...
class ValidatePlugin extends Command
{
     ...
     * @var string
     */
    protected $signature = 'dev:validate-plugin {path : Path to the plugin directory}';
     ...
     * @var string
     */
    protected $description = 'Validate plugin structure and configuration';
    ...
    public function handle(): int
    {
        ...
        $this->info("Validating plugin: {$path}...");

        $result = $service->validatePlugin($path);
