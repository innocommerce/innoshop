...
<div class="tab-pane fade" id="tab-setting-localization">
  <!-- Localization Settings -->
  <div class="card mb-4">
  ...
  <div class="card">
    <div class="card-header">
      <h5 class="card-title mb-0">{{ __('panel/setting.language_features') }}</h5>
      <p class="text-muted small mb-0">{{ __('panel/setting.language_features_desc') }}</p>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-6">
