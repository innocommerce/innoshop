          ...
          <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade mt-3" id="addition-tab-pane" role="tabpanel" aria-labelledby="addition-tab"
                ...
                <div class="d-flex flex-column flex-sm-row gap-3">
                  <div class="col-12 col-sm-6">
                    <x-common-form-select :title="__('panel/product.tax_class')" name="tax_class_id" :value="old('tax_class_id', $product->tax_class_id ?? 0)" :options="$tax_classes"
                      key="id" label="name" />
                    ...
                    <div class="pt-2"></div>
                    <x-common-form-select :title="__('panel/product.weight_class')" name="weight_class" :value="old('weight_class', $product->weight_class ?? 0)" :options="$weightClasses"
                      key="id" label="name" />
                    <x-common-form-select :title="__('panel/product.brand')" name="brand_id" :value="old('brand_id', $product->brand_id ?? 0)" :options="$brands"
                      key="id" label="name" />
              ...
              <div class="tab-pane fade mt-3" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab"
                tabindex="4">
                <x-common-form-input :title="__('panel/common.slug')" name="slug" :value="old('slug', $product->slug ?? '')" :placeholder="__('panel/common.slug')"
                    ...
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                      ...
                      <div class="mb-3 locale-code" data-locale-code={{ $localeCode }}>
                        ...
                        <x-common-form-input title="{{ __('panel/common.meta_title') }}"
                          ...
                          :translate="true" placeholder="{{ __('panel/common.meta_title') }}" column="product_title"
                          :generate="true" />
              ...
              <div class="tab-pane fade mt-3 col-md-6" id="relation-tab-pane" role="tabpanel"
                ...
                <x-panel-form-autocomplete-list name="related_ids[]" :value="old('related_ids', $product->relations->pluck('relation_id')->toArray() ?? [])"
