        ...
        <div class="container mt-1">
          <table class="table table-bordered">
            ...
            <tr class="bg-dark-subtle">
              ...
              <th scope="col">{{__('common/base.position')}}</th>
            ...
            <tr v-for="(item, index) in items" :key="index">
              ...
              <td class="align-middle text-center">
                <el-button size="small" type="danger" plain @click="open(index)">{{__('common/base.delete')}}</el-button>
              </td>
            </tr>
            ...
            <tr v-if="items.length === 0">
              <td colspan="7" style="text-align: center;">
                ...
                <el-button size="small" type="primary" @click.prevent="add">{{__('common/base.add')}}</el-button>
              </td>
            </tr>
            </tbody>
          </table>
