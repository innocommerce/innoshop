...
@section('content')
  <div id="app" class="card h-min-600">
    <div class="card-header  d-flex justify-content-between align-items-center">
      ...
      <button @click.prevent="verification" type="submit"
              class="btn btn-primary">{{__('panel/sns.save')}}</button>
    </div>
    <div class="card-body">
          ...
          <table class="table table-bordered">
           ...
           <td>
            <div class="input-group" style="display: flex; width: 100%;">
              <input type="text" class="form-control" :name="'callback_url[' + index + ']'" v-model="item.callback_url"
                style="flex-grow: 1; min-width: 280px;">
              <button class="btn btn-light" @click.prevent="copyCallbackUrl(index)" title="复制" style="flex-shrink: 0;">
              ...
              <td class="align-middle text-center">
                <i class="bi bi-x-square fs-4" @click.prevent="deleteRow(index)"
            ...
            <tr v-if="items.length > 0 && items.length < 3">
              ...
              <td colspan="7" class="text-center" style="border: 1px solid #dee2e6 !important;">
                <button type="button" class="btn btn-primary"
                        @click.prevent="addAfter(items.length - 1)">{{__('panel/sns.add')}}</button>
            ...
            <tr v-if="items.length === 0">
              <td colspan="7" style="text-align: center;">
                ...
                <button @click.prevent="add" type="button" class="btn btn-primary"> {{__('panel/sns.add')}}</button>
              </td>
            </tr>
            </tbody>
          </table>
