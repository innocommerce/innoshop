<div class="tab-pane fade mt-3" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
  ...
  <div class="mb-3">
    ...
    <x-common-form-locale-input
      name="summary"
      type="textarea"
      :translations="locale_field_data($brand, 'summary')"
  ...
  <div class="mb-3">
    ...
    <x-common-form-locale-input
      name="meta_title"
      :translations="locale_field_data($brand, 'meta_title')"
  ...
  <div class="mb-3">
    ...
    <x-common-form-locale-input
      ...
      type="textarea"
      :translations="locale_field_data($brand, 'meta_description')"
  ...
  <div class="mb-3">
    ...
    <x-common-form-locale-input
      name="meta_keywords"
      type="textarea"
      :translations="locale_field_data($brand, 'meta_keywords')"
