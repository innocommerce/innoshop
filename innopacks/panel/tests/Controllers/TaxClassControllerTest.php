...
use InnoShop\Panel\Controllers\TaxClassController;
...
class TaxClassControllerTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->reflection = new ReflectionClass(TaxClassController::class);
    }

    #[Test]
    public function test_controller_exists(): void
    {
        $this->assertTrue(class_exists(TaxClassController::class));
    }
    ...
    #[Test]
    public function test_show_method_accepts_tax_class_parameter(): void
    {
        $method     = $this->reflection->getMethod('show');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
        $this->assertEquals('taxClass', $parameters[0]->getName());
    }
    ...
    #[Test]
    public function test_store_method_accepts_tax_class_request(): void
    {
        $method     = $this->reflection->getMethod('store');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
    ...
    #[Test]
    public function test_edit_method_accepts_tax_class_parameter(): void
    {
        $method     = $this->reflection->getMethod('edit');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
    ...
    #[Test]
    public function test_update_method_accepts_request_and_tax_class(): void
    {
        $method     = $this->reflection->getMethod('update');
        $parameters = $method->getParameters();
        $this->assertCount(2, $parameters);
        $this->assertEquals('request', $parameters[0]->getName());
        $this->assertEquals('taxClass', $parameters[1]->getName());
    }

    #[Test]
    public function test_destroy_method_accepts_tax_class_parameter(): void
    {
        $method     = $this->reflection->getMethod('destroy');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
    ...
    public function test_form_data_structure(): void
    {
        ...
        $this->assertArrayHasKey('tax_rates', $data);
        $this->assertArrayHasKey('tax_rules', $data);
        $this->assertArrayHasKey('address_types', $data);
    }
