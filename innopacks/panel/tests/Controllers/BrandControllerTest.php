...
use InnoShop\Panel\Controllers\BrandController;
...
class BrandControllerTest extends TestCase
{
    ...
    #[Test]
    public function test_store_method_accepts_brand_request(): void
    {
        $method     = $this->reflection->getMethod('store');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
    ...
    #[Test]
    public function test_show_method_accepts_brand_parameter(): void
    {
        $method     = $this->reflection->getMethod('show');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
        $this->assertEquals('brand', $parameters[0]->getName());
    }

    #[Test]
    public function test_edit_method_accepts_brand_parameter(): void
    {
        $method     = $this->reflection->getMethod('edit');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
    ...
    #[Test]
    public function test_update_method_accepts_request_and_brand(): void
    {
        $method     = $this->reflection->getMethod('update');
        $parameters = $method->getParameters();
        $this->assertCount(2, $parameters);
        $this->assertEquals('request', $parameters[0]->getName());
        $this->assertEquals('brand', $parameters[1]->getName());
    }

    #[Test]
    public function test_destroy_method_accepts_brand_parameter(): void
    {
        $method     = $this->reflection->getMethod('destroy');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
