...
use InnoShop\Panel\Controllers\OrderReturnController;
...
class OrderReturnControllerTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->reflection = new ReflectionClass(OrderReturnController::class);
    }

    #[Test]
    public function test_controller_exists(): void
    {
        $this->assertTrue(class_exists(OrderReturnController::class));
    }
    ...
    #[Test]
    public function test_edit_method_accepts_order_return_parameter(): void
    {
        $method     = $this->reflection->getMethod('edit');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
        $this->assertEquals('order_return', $parameters[0]->getName());
    }

    #[Test]
    public function test_update_method_accepts_request_and_order_return(): void
    {
        $method     = $this->reflection->getMethod('update');
        $parameters = $method->getParameters();
        $this->assertCount(2, $parameters);
        $this->assertEquals('request', $parameters[0]->getName());
        $this->assertEquals('orderReturn', $parameters[1]->getName());
    }

    #[Test]
    public function test_destroy_method_accepts_order_return_parameter(): void
    {
        $method     = $this->reflection->getMethod('destroy');
        $parameters = $method->getParameters();
        $this->assertCount(1, $parameters);
    ...
    #[Test]
    public function test_change_status_method_accepts_request_and_order_return(): void
    {
        $method     = $this->reflection->getMethod('changeStatus');
        $parameters = $method->getParameters();
        $this->assertCount(2, $parameters);
    ...
    public function test_form_data_structure(): void
    {
        ...
        $this->assertArrayHasKey('next_statuses', $data);
        $this->assertArrayHasKey('order_return', $data);
    ...
    public function test_index_data_structure(): void
    {
        ...
        $this->assertArrayHasKey('order_returns', $data);
    }
}
