...
use InnoShop\Panel\Controllers\PageController;
...
class PageControllerTest extends TestCase
{
    ...
    #[Test]
    public function test_page_slug_generation(): void
    {
        $title = 'About Us';
        $slug  = strtolower(str_replace(' ', '-', $title));

        $this->assertEquals('about-us', $slug);
    }

    #[Test]
    public function test_page_active_status(): void
    {
