    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="bi bi-stars me-1"></i>{{ __('aicore::modal.ai_generate') }}
        </h5>
      ...
      <div class="modal-body">
        ...
        <div class="mb-3" id="aiModalLocaleWrapper">
          <label class="form-label small fw-medium">{{ __('aicore::modal.ai_target_language') }}</label>
          <select id="aiModalLocale" class="form-select form-select-sm">
            <option value="">{{ __('aicore::modal.ai_all_languages') }}</option>
        ...
        <div class="mt-3">
          <label class="form-label small fw-medium">{{ __('aicore::modal.ai_result') }}</label>
          <textarea id="aiModalResult" class="form-control" rows="8" placeholder="{{ __('aicore::modal.ai_result_placeholder') }}"></textarea>
          <div id="aiModalResultMulti" class="mt-2" style="display:none"></div>
          <div class="text-muted small mt-1">{{ __('aicore::modal.ai_result_hint') }}</div>
        </div>
