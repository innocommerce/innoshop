...
<div class="container">
  @if ($brands->isEmpty())
    <div class="brands-index-empty text-center py-2">
      <x-common-no-data text="{{ __('front/brand.no_brands') }}" />
    </div>
  @else
            ...
            @foreach ($items as $brand)
              <li>
                <a href="{{ $brand->url }}" class="text-secondary">
                  <div class="img"><img src="{{ image_resize($brand->logo, 200, 200) }}" class="img-fluid" alt="{{ $brand->name }}" /></div>
