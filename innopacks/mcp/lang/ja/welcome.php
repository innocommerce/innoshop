...
return [
    ...
    'arch_desc'           => 'MCP は innopacks/mcp が提供するプロトコル適合層です。すべてのツール（Tool）は innopacks/aicore で定義・管理され、両者は ToolInterface 契約によって疎結合になっています。',
    ...
    'arch_note_badge'     => 'ヒント',
    'arch_note'           => 'バックオフィス内で AI 会話を利用する場合は、<strong>ShopBot プラグイン</strong>（AI アシスタント）をインストールしてください。ShopBot も innopacks/aicore の Tool 体系に基づきますが、MCP プロトコルを介さず Web UI で直接対話します。',
    'connect_title'       => '接続ガイド',
