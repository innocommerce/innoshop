...
return [
    ...
    'arch_desc'           => 'MCP est la couche d\'adaptation du protocole fournie par innopacks/mcp ; tous les outils sont définis et maintenus dans innopacks/aicore. Les deux sont découplés via le contrat ToolInterface.',
    ...
    'arch_note'           => 'Pour utiliser l\'IA directement dans le panneau, installez le <strong>plugin ShopBot</strong> (assistant IA). Il repose sur le même système de tools d\'innopacks/aicore mais dialogue via une interface Web, sans protocole MCP.',
