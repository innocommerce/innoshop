...
return [
    ...
    'arch_desc'           => 'MCP é a camada de adaptação de protocolo fornecida por innopacks/mcp; todas as ferramentas são definidas e mantidas em innopacks/aicore. Ambas são desacopladas via contrato ToolInterface.',
    ...
    'arch_note'           => 'Para usar IA dentro do painel, instale o <strong>plugin ShopBot</strong> (assistente de IA). Ele usa o mesmo sistema de ferramentas de innopacks/aicore, mas interage via interface web, sem o protocolo MCP.',
