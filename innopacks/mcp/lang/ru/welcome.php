...
return [
    ...
    'arch_desc'           => 'MCP — это слой адаптации протокола от innopacks/mcp; все инструменты определяются и поддерживаются в innopacks/aicore. Они слабо связаны через контракт ToolInterface.',
    ...
    'arch_note'           => 'Чтобы использовать ИИ прямо в панели, установите <strong>плагин ShopBot</strong> (ИИ-ассистент). Он основан на той же системе инструментов innopacks/aicore, но взаимодействует через веб-интерфейс без протокола MCP.',
