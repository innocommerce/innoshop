...
return [
    ...
    'arch_desc'           => 'MCP는 innopacks/mcp가 제공하는 프로토콜 어댑터 계층이며, 모든 도구(Tool)는 innopacks/aicore에서 정의·관리됩니다. 둘은 ToolInterface 계약으로 느슨하게 결합됩니다.',
    ...
    'arch_note_badge'     => '팁',
    'arch_note'           => '백오피스 안에서 AI 대화를 사용하려면 <strong>ShopBot 플러그인</strong>(AI 어시스턴트)을 설치하세요. ShopBot도 innopacks/aicore의 Tool 체계를 기반으로 하지만 MCP 프로토콜 없이 Web UI로 직접 대화합니다.',
