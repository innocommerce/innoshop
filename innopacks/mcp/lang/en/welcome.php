...
return [
    ...
    'arch_note_badge'     => 'Tip',
    'arch_note'           => 'For in-panel AI chat, install the <strong>ShopBot plugin</strong> (AI Assistant). It uses the same innopacks/aicore Tool system but interacts via Web UI without MCP.',
