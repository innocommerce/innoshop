...
class SettingSeeder extends Seeder
{
    ...
    private function getSettings(): array
    {
        return [
            ...
            ['space' => 'system', 'name' => 'country_code', 'value' => 'CO'],
            ['space' => 'system', 'name' => 'state_code', 'value' => 'DC'],
            //['space' => 'system', 'name' => 'front_locale', 'value' => 'en'], //Instala ecommerce en ingles, incluye todos los seeder
            ['space' => 'system', 'name' => 'front_locale', 'value' => 'es'],
            ...
            ['space' => 'system', 'name' => 'currency', 'value' => 'COP'],
            ...
            [
                ...
                'name'  => 'meta_title',
                'value' => [
                    'es'    => 'InnoShop - Innovative Open Source E-commerce System - Built on Laravel 11, with multi-language and multi-currency support, a powerful e-commerce system based on a Hook-based plugin architecture.',
                ],
            ],
            [
                'space' => 'system',
                'name'  => 'meta_keywords',
                'value' => [
                    'es'    => 'InnoShop, Innovation, Open Source, E-commerce, Laravel 11, Multi-language, Multi-currency, Hook, Plugin architecture, Flexible, Powerful',
                ],
            ],
            [
                'space' => 'system',
                ...
                'value' => [
                    'es'    => 'InnoShop is an innovative open-source e-commerce platform developed based on Laravel 11, featuring multi-language and multi-currency support. It adopts a powerful and flexible plugin architecture based on Hooks, providing users with a wealth of customization and extension capabilities. Welcome to experience InnoShop and create your own e-commerce platform!',
                ],
            ],
            [
                'space' => 'system',
