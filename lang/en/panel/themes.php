...
return [
    ...
    'import_clear_default_catalog'      => 'Clear existing catalog data first',
    'import_clear_default_catalog_help' => 'When checked, products, categories, brands, and related orders, cart lines, favorites, and reviews are removed before the demo import. Off by default. Use with care in production.',
    ...
    'error_demo_seeder_invalid'         => 'Demo seeder file is invalid, must return a closure',
    'error_demo_seeder_failed'          => 'Demo seeder failed: :error',
