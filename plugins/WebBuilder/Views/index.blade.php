...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ panel_locale_direction() }}">
    <head>
        ...
        <title>{{ __('MobileBuilder::route.title') }} - InnoShop</title>
                        ...
                        <div class="editable-area">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    <!-- 原有的工具栏 -->
                                    <div class="module-tool" style="display: none;">
                                                ...
                                                <div class="product-grid-item">
                                                    ...
                                                    <div class="product-item-info">
                                                        <div class="product-name">
                                                            <a :href="item.url || 'javascript:;'">@{{ item.name || '' }}</a>
                                                        </div>
                                                        <div class="product-bottom">
{{--                                                            <div class="product-bottom-btns">--}}
{{--                                                                <div class="btn-add-cart cursor-pointer">--}}
{{--                                                                    加入购物车--}}
{{--                                                                </div>--}}
{{--                                                            </div>--}}
...
{{--                                                    <a :href="item.link.value ? item.link.value : 'javascript:;'">--}}
                                    ...
                                    <div v-if="module && module.code == 'four_image-plus' && module.content">
                                        ...
                                        <div v-if="module.content.images && module.content.images.length" class="container d-flex justify-content-center">
                                            <div class="row col-md-10">
                                                <!-- 第一列，大图片 -->
                                                <div class="col-lg-6 col-md-12 mb-3 d-flex align-items-center justify-content-center">
                                                    <div class="image-item">
                                                        <a :href="module.content.images[0].link.value || 'javascript:;'">
                                                            <img :src="module.content.images[0].image[source.locale] || module.content.images[0].image['zh_cn'] || Object.values(module.content.images[0].image)[0] || '{{ plugin_asset('mobile_builder', 'images/demo/product/1-600x600.png') }}'" class="img-fluid rounded image-large">
                                                        </a>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-6 mb-3 d-flex align-items-center justify-content-center">
                                                            <div class="image-item">
                                                                <a :href="module.content.images[1].link.value || 'javascript:;'">
                                                                    <img :src="module.content.images[1].image[source.locale] || module.content.images[1].image['zh_cn'] || Object.values(module.content.images[1].image)[0] || '{{ plugin_asset('mobile_builder', 'images/demo/product/2-600x600.png') }}'" class="img-fluid rounded image-small">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-6 mb-3 d-flex align-items-center justify-content-center">
                                                            <div class="image-item">
                                                                <a :href="module.content.images[2].link.value || 'javascript:;'">
                                                                    <img :src="module.content.images[2].image[source.locale] || module.content.images[2].image['zh_cn'] || Object.values(module.content.images[2].image)[0] || '{{ plugin_asset('mobile_builder', 'images/demo/product/3-600x600.png') }}'" class="img-fluid rounded image-small">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-12 d-flex align-items-center justify-content-center">
                                                            <div class="image-item">
                                                                <a :href="module.content.images[3].link.value || 'javascript:;'">
                                                                    <img :src="module.content.images[3].image[source.locale] || module.content.images[3].image['zh_cn'] || Object.values(module.content.images[3].image)[0] || '{{ plugin_asset('mobile_builder', 'images/demo/product/4-600x600.png') }}'" class="img-fluid rounded image-wide">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            const app = new Vue({
                ...
                methods: {
                    ...
                    handleDragChange(evt) {
                        ...
                        // 如果是跨列表移除(通常是拖到别处)，不过你左侧 put=false 所以一般用不到
                        else if (evt.removed) {
...
<!-- 添加组件定义 -->
<script type="text/javascript">
    Vue.component('module-editor-article', {  // 注意这里的下划线
...
/* 左侧大图特殊处理 */
.preview-container .module-four-image-plus .col-md-6:first-child .image-wrap {
    background: #f8f8f8;
}
.preview-container .module-four-image-plus .col-md-6:first-child .image-wrap img {
    width: 100%;
    height: 100%;
    object-position: center;
}
.preview-container .module-four-image-plus .image-item:hover img {
    transform: scale(1.05);
}
.preview-container .module-four-image-plus .image-text {
    position: absolute;
    left: 0;
    right: 0;
    bottom: 30px;
...
.preview-container .module-four-image-plus .image-sub-text {
    position: absolute;
    left: 0;
    right: 0;
    bottom: 10px;
...
<template id="module-editor-four-image-plus-template">
    <div class="module-four-image-plus">
        <div class="container">
            <div v-if="module.content.title && module.content.title[source.locale]" class="module-title-wrap text-center mb-4">
                <div class="module-title h3">@{{ module.content.title[source.locale] }}</div>
                <div v-if="module.content.subtitle && module.content.subtitle[source.locale]" class="module-sub-title text-muted">
                    @{{ module.content.subtitle[source.locale] }}
                </div>
            </div>

            <div class="row g-3">
                <div class="col-md-6">
                    <div v-if="module.content.images && module.content.images[0]" class="image-item h-100">
                        <a :href="module.content.images[0].link.link || 'javascript:void(0)'" class="d-block h-100">
                            <div class="image-wrap">
                                <img :src="module.content.images[0].image[source.locale]"
                                     :style="'object-fit:' + (module.content.images[0].object_fit || 'cover')"
                                     alt="">
                            </div>
                            <div v-if="module.content.images[0].text && module.content.images[0].text[source.locale]"
                                 class="image-text">@{{ module.content.images[0].text[source.locale] }}</div>
                            <div v-if="module.content.images[0].sub_text && module.content.images[0].sub_text[source.locale]"
                                 class="image-sub-text">@{{ module.content.images[0].sub_text[source.locale] }}</div>
                        </a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="right-images">
                        <template v-for="(image, index) in module.content.images.slice(1, 4)">
                            <div :class="['image-item', index < 2 ? 'small-image' : 'wide-image']">
                                <a :href="image.link.link || 'javascript:void(0)'" class="d-block h-100">
                                    <div class="image-wrap">
                                        <img :src="image.image[source.locale]"
                                             :style="'object-fit:' + (image.object_fit || 'cover')"
                                             alt="">
                                    </div>
                                    <div v-if="image.text && image.text[source.locale]"
                                         class="image-text">@{{ image.text[source.locale] }}</div>
                                    <div v-if="image.sub_text && image.sub_text[source.locale]"
                                         class="image-sub-text">@{{ image.sub_text[source.locale] }}</div>
                                </a>
                            </div>
                        </template>
                    </div>
...
<!-- 编辑器模板 -->
<template id="module-editor-four-image-plus-edit-template">
    <div class="image-edit-wrapper">
        <!-- ... 其他编辑选项 ... -->
        <div class="module-edit-group">
            <div class="module-edit-title">图片设置</div>
                ...
                <div class="pb-images-selector" v-for="(item, index) in form.images" :key="index">
                    ...
                    <div :class="'pb-images-list ' + (item.show ? 'active' : '')">
                        <div class="pb-images-top">
                            ...
                            <!-- 添加图片填充模式选择 -->
                            <div class="module-edit-subtitle mt-3">图片填充方式</div>
                            <el-select v-model="item.object_fit" placeholder="请选择">
                                <el-option label="填满（可能裁剪）" value="cover"></el-option>
                                <el-option label="完整显示（可能留白）" value="contain"></el-option>
                            </el-select>
                        </div>
                        <!-- ... 其他编辑选项 ... -->
                    </div>
...
<style>
/* 预览区的一行四图模块样式 */
.preview-container .module-four-image {
    padding: 30px 0;
}
.preview-container .module-four-image .image-grid {
    display: grid;
    grid-template-columns: repeat(4, 1fr);
    gap: 20px;
}
.preview-container .module-four-image .image-item {
    position: relative;
    overflow: hidden;
    border-radius: 8px;
    background: #f8f8f8;
}
.preview-container .module-four-image .image-wrap {
    position: relative;
    width: 100%;
    height: 300px;
    overflow: hidden;
...
.preview-container .module-four-image .image-wrap img {
    width: 100%;
    height: 100%;
    transition: transform 0.3s ease;
}
.preview-container .module-four-image .image-item:hover img {
    transform: scale(1.05);
}
.preview-container .module-four-image .image-text {
    position: absolute;
    left: 0;
    right: 0;
    bottom: 30px;
...
.preview-container .module-four-image .image-sub-text {
    position: absolute;
    left: 0;
    right: 0;
    bottom: 10px;
    ...
    <div class="module-four-image">
        <div class="container">
            ...
            <div class="image-grid">
                <template v-for="(image, index) in module.content.images">
                    <div class="image-item">
