...
namespace Plugin\MetaPixel\Services;

use Exception;
use InnoShop\Common\Services\BaseService;

class MetaPixelService extends BaseService
{
    ...
    {
        return view('MetaPixel::head_tag')->render();
    }

    /**
     * See https://developers.facebook.com/docs/meta-pixel/implementation/marketing-api
    ...
    public function otherEventTag($globalData): string
    {
        ...
        $tags .= $this->getPurchaseTag($globalData);
    ...
    private function getSearchTag($globalData): string
    {
        if ($this->routeName == 'products.index' && request('keyword')) {
            ...
            return view('MetaPixel::search', $data)->render();
        } else {
            return '';
        }
    }
    ...
    private function getViewContentTag($globalData): string
    {
        if ($this->routeName == 'products.show' || $this->routeName == 'products.slug_show') {
            ...
            return view('MetaPixel::view_content', $data)->render();
        } else {
            return '';
        }
    }
    ...
    private function getAddToCartTag(): string
    {
        ...
        return view('MetaPixel::add_to_cart', $data)->render();
    }
    ...
    private function getAddToWishlistTag(): string
    {
        ...
        return view('MetaPixel::add_to_wishlist', $data)->render();
    }
    ...
    private function getInitiateCheckoutTag($globalData): string
    {
        if (in_array($this->routeName, ['checkout.index', 'multi.checkout.index'])) {
            ...
            return view('MetaPixel::init_checkout', $data)->render();
        } else {
            return '';
        }
    }
     ...
     * @return string
     */
    private function getPurchaseTag($globalData): string
    {
        if ($this->routeName == 'checkout.success') {
            ...
            return view('MetaPixel::purchase', $data)->render();
        } else {
            return '';
        }
    }
