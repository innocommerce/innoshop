...
namespace Plugin\EmailVerification\Notifications;

use Illuminate\Bus\Queueable;
use Illuminate\Contracts\Queue\ShouldQueue;
use Illuminate\Notifications\Notification;
use InnoShop\Common\Models\Customer;
use Plugin\EmailVerification\Mails\VerificationMail;
...
class VerificationNotification extends Notification implements ShouldQueue
{
    ...
    {
        return (new VerificationMail($this->code, $this->customer->email))
            ->to($notifiable->email);
    }
