        ...
        <div class="container">
          <div class="row" style="width: 70%;">
            <div  v-for="(item, index) in items" :key="index" class="col-4 d-flex align-items-center">
              ...
              <input v-if="item.state === '{{ __('FlexShipping::route.sort') }}'" type="number" v-model.number="item.frame" class="form-control w-100">
              <select v-if="['{{ __('FlexShipping::route.state') }}', '{{ __('FlexShipping::route.state_debugging') }}'].includes(item.state)" v-model.number="item.frame" class="form-control w-100">
                <option value="{{ __('FlexShipping::route.forbidden') }}">{{ __('FlexShipping::route.forbidden') }}</option>
          ...
          <div class="d-flex gap-5" style="margin-top: 60px;">
            <div class="col-md-2">
              <div @click="setSelectedItem(index)" :class="{'selected': selectedIndex === index}" class="move"
                ...
                <div class="movediv">@{{ item.list[selectedItem.subIndx].from.display_namecn || item.name }}</div>
                <div>
                ...
                <div class="mt-3">
                      ...
                      <div class="row w-100">
                        <div class="col-6">
                          <div class="input-group">
                            ...
                            <input v-model="selectedItem.list[selectedItem.subIndx].from.display_namecn" type="text"
                                   class="Informationbox form-control" placeholder="中文" aria-label="Username"
                        ...
                        <div class="col-6">
                          <div class="input-group">
                            ...
                            <textarea v-model="selectedItem.list[selectedItem.subIndx].from.description_cn"
                                      placeholder="中文"
                                      class="Informationbox form-control" aria-label="With textarea"></textarea>
                          </div>
                  ...
                  <div class="mb-3">
                    <div class="d-flex">
                      ...
                      <div class="row w-100">
                        <div class="col-6">
                          <select v-model="selectedItem.list[selectedItem.subIndx].from.category_tax"
                                  class="form-select"
                      ...
                      <div class="d-flex">
                        ...
                        <div style="flex-grow: 1; margin-left: 50px;">
                          <input v-model="selectedItem.list[selectedItem.subIndx].from.regional_group"
                                 class="form-control"
                                 placeholder="{{ __('FlexShipping::route.group') }}" aria-label="Username" aria-describedby="basic-addon1">
                          <div class="mt-2">{{ __('FlexShipping::route.turn') }}
                            <a href="{{panel_route('regions.index')}}" target="_blank"
                               style="text-decoration: none;">{{ __('FlexShipping::route.configuration') }}</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mb-3">
                      <div class="d-flex">
                        ...
                        <div style="flex-grow: 1; margin-left: 65px;">
                          ...
                          <div v-if="selectedItem.list[selectedItem.subIndx].from.service==1"
                      ...
                      <div class="d-flex">
                        ...
                        <div style="flex-grow: 1; margin-left: 80px;">
                          ...
                          <div v-if="selectedItem.list[selectedItem.subIndx].from.currency === 'currencies'"
                            ...
                            <section class="selection_option">
                              <label class="checkbox-inline mb-1 me-1">
                                <input v-model="selectedItem.list[selectedItem.subIndx].from.currencies"
                                       type="checkbox"
                                       :value="'CNY'">
                ...
                <div class="mt-3">
                  <div class="mb-3">
                    <div class="d-flex gap-3" style="width: 100%;">
                      ...
                      <div style="margin-left: 15px;" class="flex-grow-1">
                        <select v-model="selectedItem.list[selectedItem.subIndx].from.terms_commodity"
                                class="form-select"
                  ...
                  <div class="mb-3">
                    <div class="d-flex gap-3" style="width: 100%;">
                      ...
                      <div style="margin-left: 15px;" class="flex-grow-1">
                        <select v-model="selectedItem.list[selectedItem.subIndx].from.goods_category"
                                class="form-select"
                    ...
                    <div class="d-flex gap-3" style="width: 100%;">
                      ...
                      <div style="margin-left: 15px;" class="flex-grow-1">
                        <select v-model="selectedItem.list[selectedItem.subIndx].from.brand_conditions"
                                class="form-select"
                                style="width: 45%;" aria-label="品牌条件选择">
                          ...
                          <div style="flex: 1;">
                            <select class="form-control" v-model="selectedItem.list[selectedItem.subIndx].from.afternoon">
                              ...
                              @for ($i = 0; $i <= 23; $i++) <option value="{{ $i < 10 ? ('0' . $i) : $i }}:00">
                                {{ $i < 10 ? ('0' . $i) : $i }}:00 @if ($i < 12) {{ __('FlexShipping::route.forenoon') }} @else {{
                                  __('FlexShipping::route.afternoon') }} @endif </option>
                                  @endfor
                            </select>
                          </div>
                          <div style="flex: 1;">
                ...
                <div class="mt-3">
                  <div class="mb-3">
                    <div class="d-flex gap-3 align-items-center">
                      ...
                      <div class="col-6">
                        <select v-model="selectedItem.list[selectedItem.subIndx].from.billing"
                    ...
                    <div class="mt-3 mb-3 d-flex gap-3 align-items-center"
                      ...
                      <div class="col-6">
                        <div class="input-group mb-3 mt-3">
                          ...
                          <input min="0" v-model="selectedItem.list[selectedItem.subIndx].from.billing_usd"
                                 type="number"
                                 class="form-control" placeholder="{{ __('FlexShipping::route.enter_amount') }}" aria-label="{{ __('FlexShipping::route.enter_amount') }}"
                                 aria-describedby="basic-addon1">
                        </div>
                      </div>
                    </div>
                            ...
                            <tr v-for="(item, index) in selectedItem.list[selectedItem.subIndx].from.items"
                              ...
                              <td>
                                <div class="input-group">
                                  ...
                                  <input min=0 v-model="item.start_value" type="number" class="form-control"
                                         aria-label="{{ __('FlexShipping::route.start_value') }}" aria-describedby="{{ __('FlexShipping::route.start_value') }}">
                                </div>
                              </td>
                              <td>
                                <div class="input-group">
                              ...
                              <td>
                                <div class="mt-2 d-flex justify-content-center" style="width: 130px;">
                                  <div class="btn btn-danger" @click="deleteItem(index)">{{ __('FlexShipping::route.delete')}}</div>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td class="mt-2 d-flex justify-content-center">
                                <div class="btn btn-primary" @click="add_rules">{{ __('FlexShipping::route.add_fee_rule')}}</div>
                              </td>
                            </tr>
                            </tbody>
                          </table>
                        ...
                        <div>
                          <div class=" mb-3 d-flex gap-3 align-items-center">
                            ...
                            <div class="col-6">
                              <div class="input-group mb-3 mt-3">
                                <span class="input-group-text" id="basic-addon1">{{ __('FlexShipping::route.usd') }}</span>
                                <input v-model="selectedItem.list[selectedItem.subIndx].from.extra"
                                       class="form-control"
                                       placeholder="{{ __('FlexShipping::route.enter_amount') }}" aria-label="{{ __('FlexShipping::route.enter_amount') }}"
                                       aria-describedby="basic-addon1">
                              </div>
                            </div>
                          </div>
     ...
     const app = createApp({
      ...
      const logSelectedItem = () => {
        const filteredItems = delivermove.value.map(item => {
          const {name, subIndx, idx, ...rest} = item;
          return {
            ...rest,
