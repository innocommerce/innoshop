...
namespace Plugin\TwitterCard;

use Exception;
use InnoShop\Plugin\Core\BaseBoot;
use Plugin\TwitterCard\Services\TagService;
...
class Boot extends BaseBoot
{
    ...
    private function addOpenGraphTags(): void
    {
        listen_blade_insert('front.layout.app.head.bottom', function ($data) {
            ...
            $tagData = TagService::getInstance()->getTagData($type, $instance);
            if (empty($tagData)) {
                return '';
            }

            return view('TwitterCard::twitter_card_tags', $tagData);
        });
    }
}
